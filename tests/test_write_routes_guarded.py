...
# verify, and a tenant switch that is that same verify), the calendar index (a read-only scan into a local SQLite file), and a job's Stop (a flag
...
LOCAL_ONLY = {
    ...
    "/setup/import", "/setup/fresh", "/setup/verify", "/setup/switch",
