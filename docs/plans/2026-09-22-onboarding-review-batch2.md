...
**Status: NOT STARTED.** Working tree clean at `37b2e22`; every "replace this exact block" below
matches verbatim. Self-contained for any model/person with no session context.
